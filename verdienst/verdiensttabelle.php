...
class tabelle {
  function __construct() {
    ...
    $this->felder = array (
      ...
      "la300"  => (new zeile("w", "INT(11)" , "Gehalt (JLL)"                                  , "219060"  , ""  )),
      ...
      "BRG"    => (new zeile("w", "INT(11)" , "Gesamtbrutto"                                  , "245533"  , ""  )),
      "BSL"    => (new zeile("w", "INT(11)" , "Steuerbrutto, laufende Bezüge"                 , "245533"  , ""  )),
      ...
      "LSE"    => (new zeile("w", "INT(11)" , "Lohnsteuer aus sonstigen Bezügen"              , "- Minus" , ""  )),
      "LST"    => (new zeile("w", "INT(11)" , "Lohnsteuer aus monatlichen Bezügen"            , "- Minus" , ""  )),
      "LAG"    => (new zeile("w", "INT(11)" , "Lohnsteuerausgleich"                           , "- Minus" , ""  )),
      "SOZ"    => (new zeile("w", "INT(11)" , "Solidaritätszuschlag"                          , "- Minus" , ""  )),
      "SAG"    => (new zeile("w", "INT(11)" , "Solidaritätszuschlag, Jahresausgleich"         , "- Minus" , ""  )),
      "BRK"    => (new zeile("w", "INT(11)" , "Krankenversicherungsbrutto"                    , "245533"  , ""  )),
      "BEK"    => (new zeile("w", "INT(11)" , "Krankenversicherungsbrutto Einmalbezüge"       , " "       , ""  )),
      "KAN"    => (new zeile("w", "INT(11)" , "KV AN [allgemeiner Beitrag]"                   , "- Minus" , "Krankenversicherung Arbeitnehmeranteil")),
      "KZA"    => (new zeile("w", "INT(11)" , "KV Zusatzbeitrag AN [allgemeiner Beitrag]"     , "- Minus" , "Krankenversicherung Arbeitnehmeranteil")),
      "KEN"    => (new zeile("w", "INT(11)" , "KV AN Einmalbezug [allgemeiner Beitrag]"       , "- Minus" , "Krankenversicherung Arbeitnehmeranteil")),
      "KZE"    => (new zeile("w", "INT(11)" , "KV Zusatzbeitrag AN EMZ [allgemeiner Beitrag]" , "- Minus" , "Krankenversicherung Arbeitnehmeranteil")),
      "BRR"    => (new zeile("w", "INT(11)" , "Rentenversicherungsbrutto"                     , "245533"  , ""  )),
      "BER"    => (new zeile("w", "INT(11)" , "Rentenversicherungsbrutto Einmalbezüge"        , " "       , ""  )),
      "RAN"    => (new zeile("w", "INT(11)" , "RV AN [voller Beitrag]"                        , "- Minus" , "Rentenversicherung Arbeitnehmeranteil")),
      "PAN"    => (new zeile("w", "INT(11)" , "PV AN [voller Beitrag]"                        , "- Minus" , "Pflegeversicherung Arbeitnehmeranteil")),
      "PEN"    => (new zeile("w", "INT(11)" , "PV AN Einmalbezug [voller Beitrag]"            , "- Minus" , "Pflegeversicherung Arbeitnehmeranteil")),
      "AAN"    => (new zeile("w", "INT(11)" , "AV AN [voller Beitrag]"                        , "- Minus" , "Arbeitlosenversicherung Arbeitnehmeranteil")),
      "REN"    => (new zeile("w", "INT(11)" , "RV AN Einmalbezug [voller Beitrag]"            , "- Minus" , "Rentenversicherung Arbeitnehmeranteil")),
      "AEN"    => (new zeile("w", "INT(11)" , "AV AN Einmalbezug [voller Beitrag]"            , "- Minus" , "Arbeitlosenversicherung Arbeitnehmeranteil")),
      ...
      "UVM"    => (new zeile("w", "INT(11)" , "Überzahlung aus dem Vormomat"                  , "- Minus" , ""  )),
