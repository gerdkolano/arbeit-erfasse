...
class tabelle {
  ...
  $this->felder = array (
    ...
    "erscheine"            => (new zeile("w", "text"    , "Erscheine"                  , "12.12"       , "Zeit oder 'frei'/'Urlaub'/'BA'/'BR'/'BV'/'Seminar'")),
    ...
    "pause1_geht"          => (new zeile("w", "text"    , "Geht in die 1.Pause"        , "16.17"       , "Pause beginnt" )),
    "pause1_kommt"         => (new zeile("w", "text"    , "Kommt aus der 1.Pause"      , "16.32"       , "Pause endet" )),
    "pause2_geht"          => (new zeile("w", "text"    , "Geht in die 2.Pause"        , "19.01"       , "Pause beginnt" )),
    "pause2_kommt"         => (new zeile("w", "text"    , "Kommt aus der 2.Pause"      , "19.16"       , "Pause endet" )),
    ...
    "saldo_zges_woche"     => (new zeile("w", "text"    , "Saldo ZGES wöchentlich"     , "23.02"       , "immer sonntags. Bedeutet??" )),
    ...
    "i_arbzeit_dauer"      => (new zeile("w", $decimal  , "Arbz. / h"                  , "8.00"        , "ZEG zeigt Arbeitszeit, Infotaste gedrückt" )),
    "i_arbzeit_datum"      => (new zeile("w", "date"    , "Arbz. Datum"                , "03.03.16"    , "ZEG zeigt Datum des letzen Einsatzes" )),
    "i_saldo_dauer"        => (new zeile("w", $decimal  , "Saldo Dauer"                , "29.16"       , "ZEG zeigt Saldo" )),
    "i_saldo_datum"        => (new zeile("r", "text"    , "Saldo Datum"                , "04.03.16"    , "ZEG zeigt Datum des Saldos" )),
