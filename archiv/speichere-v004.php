...
function tu_was( $table_name, $gepostet, $conn) {
  ...
  wie_weiter_anker( strtok ( $rufer, "?"),                     "W010 Erfasse weitere Daten. Langformular.");
  printf( " oder <br />\n");
  wie_weiter_anker( sprintf( "%s?%s=%s", strtok ( $rufer, "?"), (new GET_parameter)->get_name_fuer_id, $last_inserted), "W040 Ändere die soeben erfassten Daten. Langformular. " . $gepostet->id());
  printf( " oder <br />\n");
  wie_weiter_anker( strtok ( $rufer, "?") . "?k=1",                     "W020 Erfasse weitere Daten Kurzformular.");
  printf( " oder <br />\n");
  wie_weiter_anker( sprintf( "%s&%s=%s", $rufer, (new GET_parameter)->get_name_fuer_id, $last_inserted), "W030 Ändere die soeben erfassten Daten. Kurzformular. " . $gepostet->id());
  printf( " oder <br />\n");
 
  printf( "%s", "W050 " . wie_weiter_form());
