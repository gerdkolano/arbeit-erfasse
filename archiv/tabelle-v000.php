...
class tabelle {
  ...
  $this->felder = array (
    ...
    "nehme_arbeit_auf"     => (new zeile( "text    ", "nehme"                      , "12.45"              , "nehme die Arbeit auf" )),
    ...
    "kunden"               => (new zeile( "text    ", "Anzahl Kunden"              , "250"                , "Anzahl der Kunden" )),
    ...
    "pos_je_stunde"        => (new zeile( "text    ", "Pos/h"                      , "2907"               , "Positionen je Stunde, Kassenleistung" )),
    ...
    "arbzeit_ist_anfang"   => (new zeile( "text    ", "Tatsächlich Anfang"         , "12:45"              , "Anfang des Einsatzes tatsächlich" )),
    "arbzeit_ist_ende"     => (new zeile( "text    ", "Tatsächlich Ende"           , "21:10"              , "Ende des Einsatzes tatsächlich" )),
    ...
    "i_arbzeit_dauer"      => (new zeile( "text    ", "Info Arbeitszeit Dauer"     , "8.00"               , "Drücke Infotaste" )),
