...
class gfos_zeile {
  ...
  function __construct() {
    $rot = "<td style=\"background-color:#ffeeee\">";
    $this->ausfelder = array (
      ...
      "saldo_echt"    => new  gfos_ausgabe_element("ekum"  , "<th> %s " , "$rot %s "), // Nicht autorisierte Überziehungen verfallen 5.10.15
    );
