...
class tabelle {
  ...
  $this->felder = array (
    ...
    "i_arbzeit_dauer"      => (new zeile("w", "text    ", "Arbeitszeit Dauer Info "    , "8.00"           , "Drücke Infotaste" )),
    "i_arbzeit_datum"      => (new zeile("w", "text    ", "                 Datum"     , "03.03.16"       , "ZEG zeigt Dauer und Datum des letzen Einsatzes" )),
    "i_saldo_dauer"        => (new zeile("w", "text    ", "     Saldo Dauer"           , "29.16"          , "ZEG zeigt Saldo und Datum" )),
    "i_saldo_datum"        => (new zeile("w", "text    ", "     Saldo Datum"           , "04.03.16"       , "ZEG zeigt Saldo und Datum" )),
