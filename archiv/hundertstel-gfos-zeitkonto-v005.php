...
class salden  {
  ...
  public function delta( $alt, $neu) {
    $delta = $alt - $neu;
    $this->inc_salden_kum_und_echt( -$delta, -$delta);
...
#$salden->set_summe_ist_und_summe_soll( 0.0, 0.0);
      ...
      for ($ii = 0; $ii < count( $kommt_geht); $ii++) {
        ...
        $anfangszeit = max( $value["arbzeit_plan_anfang"], $kommt_geht[$ii]);
...
/*  
        //                       vorher nachher  
        case "2016-03" : $delta =   3285 -  -  226; $salden->inc_salden_kum_und_echt( -$delta, -$delta); break;
        case "2016-02" : $delta =   3285 -  -  226; $salden->inc_salden_kum_und_echt( -$delta, -$delta); break;
        case "2015-12" : $delta =   1988 -    1709; $salden->inc_salden_kum_und_echt( -$delta, -$delta); break;
        case "2015-08" : $delta =   2048 -     342; $salden->inc_salden_kum_und_echt( -$delta, -$delta); break;
*/  
        default : break;
    }
